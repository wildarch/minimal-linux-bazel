...
def raze_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:arrayvec-0.4.10.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:autocfg-0.1.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:bitflags-1.0.4.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:byteorder-1.3.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:bytes-0.4.12.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:cc-1.0.31.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:cfg-if-0.1.7.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:cloudabi-0.0.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:crossbeam-deque-0.7.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:crossbeam-epoch-0.7.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:crossbeam-queue-0.1.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:crossbeam-utils-0.6.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:fnv-1.0.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:fuchsia-cprng-0.1.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:fuchsia-zircon-0.3.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:fuchsia-zircon-sys-0.3.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:futures-0.1.25.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:h2-0.1.17.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:http-0.1.16.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:httparse-1.3.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:hyper-0.12.25.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:indexmap-1.0.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:iovec-0.1.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:itoa-0.4.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:kernel32-sys-0.2.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:lazy_static-1.3.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:lazycell-1.2.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:libc-0.2.50.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:lock_api-0.1.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:memoffset-0.2.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:mio-0.6.16.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:miow-0.2.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:net2-0.2.33.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:nix-0.13.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:nodrop-0.1.13.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:num_cpus-1.10.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:owning_ref-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:parking_lot-0.7.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:parking_lot_core-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand-0.6.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_chacha-0.1.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_core-0.3.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_core-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_hc-0.1.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_isaac-0.1.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_jitter-0.1.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_os-0.1.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_pcg-0.1.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rand_xorshift-0.1.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rdrand-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:redox_syscall-0.1.51.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:rustc_version-0.2.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:scopeguard-0.3.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:semver-0.9.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:semver-parser-0.7.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:slab-0.4.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:smallvec-0.6.9.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:stable_deref_trait-1.1.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:time-0.1.42.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-0.1.17.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-current-thread-0.1.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-executor-0.1.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-io-0.1.12.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-reactor-0.1.9.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-sync-0.1.4.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-tcp-0.1.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-threadpool-0.1.12.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-timer-0.2.10.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:tokio-trace-core-0.1.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:try-lock-0.2.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:void-1.0.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:want-0.0.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:winapi-0.2.8.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:winapi-0.3.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:winapi-build-0.1.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:winapi-i686-pc-windows-gnu-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:winapi-x86_64-pc-windows-gnu-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//application/raze/remote:ws2_32-sys-0.2.1.BUILD")
    )
